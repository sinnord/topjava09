...
- авторизированного пользователя получаем в слое web, обращение к хранилищу делаем в слое repository, конвертацию в MealWithExceeded можно делать как в слое web, так и в service
